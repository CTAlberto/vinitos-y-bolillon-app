...
<div class="container mt-5">
    ...
    <div class="row mb-5" data-aos="fade-up" data-aos-duration="1000" style="background-color: #f8f9fa; border-radius: 8px; padding: 30px 0;">
        <div class="col-12 text-center" data-aos="fade-up" data-aos-duration="1000">
            <h2 style="font-weight: bold; color: #333; margin-bottom: 7px;">¿Por qué elegir nuestros cursos?</h2>
            <ul class="list-unstyled text-muted" style="font-size: 1.1rem; text-align: left; margin-left: 15%;">
    ...
    <div class="row mb-5" data-aos="fade-up" data-aos-duration="1000" style="background-color: #e9ecef; border-radius: 8px; padding: 30px 0;">
        <div class="col-12 text-center">
            <h2 class="mb-4" style="font-weight: bold; color: #333; margin-bottom: 7px;">Nuestra Metodología</h2>
            <p class="text-muted" style="font-size: 1.1rem; text-align: left; margin-left: 15%;" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
            ...
            <ul class="list-unstyled text-muted" style="font-size: 1.1rem; text-align: left; margin-left: 15%;" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
    ...
    <div class="row mb-5" data-aos="fade-up" data-aos-duration="1000" style="background-color: #f8f9fa; border-radius: 8px; padding: 40px 0;">
        <div class="col-12 text-center">
            <h2 style="font-weight: bold; color: #333; margin-bottom: 7px;">Testimonios</h2>
            <p class="text-muted" style="font-size: 1.1rem; text-align: left; margin-left: 15%;" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
            ...
            <h5 class="text-primary" style="font-weight: 600;">Juan Pérez, Director de Recursos Humanos, XYZ Corp.</h5>
        </div>
    </div>

    <!-- Llamado a la Acción -->
    <div class="row justify-content-center mt-5 mb-8" data-aos="fade-up" data-aos-duration="1000" style="background-color: #f1f3f5; border-radius: 8px; padding: 50px 0;">
    <div class="col-md-6 text-center">
        <h3 style="font-weight: bold; color: #333; margin-bottom: 7px;">¿Listo para transformar tu equipo?</h3>
        <p class="text-muted" style="font-size: 1.1rem; text-align: left; margin-left: 15%;" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
